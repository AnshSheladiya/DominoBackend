...
const MSG = {
  ...
  SECURITY_QUESTION_ANSWERED_SUCCESS: 'Successfully answered security question.',
  PASSWORD_RESET_LINK_SENT_SUCCESS: 'Successfully sent password reset link.',
  EMAIL_VERIFICATION_LINK_SENT_SUCCESS: 'Successfully sent email verification link.',
  ...
  ACCOUNT_ACTIVATION_EMAIL_SENT_SUCCESS: 'Activation email was successfully sent.',
  PASSWORD_RESET_EMAIL_SENT_SUCCESS: 'Password reset email was successfully sent.',
  ...
  PASSWORD_CHANGED_EMAIL_SENT_SUCCESS: 'Password changed email was successfully sent.',
  ...
  FEATURE_REQUEST_SUBMITTED_SUCCESS: 'Feature request was successfully submitted.',
  FEATURE_REQUEST_APPROVED_SUCCESS: 'Feature request was successfully approved.',
  FEATURE_REQUEST_REJECTED_SUCCESS: 'Feature request was successfully rejected.',
  ...
  INVALID_RESOURCE_OWNER_PASSWORD_CREDENTIALS: 'Invalid resource owner password credentials.',
  INVALID_RESOURCE_OWNER_USERNAME_CREDENTIALS: 'Invalid resource owner username credentials.',
  ...
  PAYMENT_AUTH_ERROR: 'There was an error authorizing your payment. Please check your card details and try again.',
  PAYMENT_DECLINED: 'Your payment was declined. Please check your card details and try again.',
  PAYMENT_PROCESSING_ERROR: 'There was an error processing your payment. Please try again later.',
  PAYMENT_ERROR: 'There was an error processing your payment. Please contact support for assistance.',
  ...
  SHIPPING_ALREADY_EXISTS: 'Shipping information with this information already exists.',
...
// Category related messages
  ...
  SUCCESS_UPLOAD_CATEGORY: "Images uploaded and associated with the category successfully",
